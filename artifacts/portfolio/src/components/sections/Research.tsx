    ...
    <section id="research" className="py-20 lg:py-28 px-6 lg:px-8 bg-background scroll-mt-20">
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="font-serif italic text-lg sm:text-xl text-muted-foreground max-w-2xl">
            "Some of the most important design work happens before anyone opens Figma."
          </p>
        </motion.div>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {/* Card 1 — Kagawa University */}
          <motion.div
            initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={fadeUp}
            className="relative bg-card rounded-2xl p-7 lg:p-9 border border-border shadow-sm overflow-hidden flex flex-col"
          >
            ...
            <div className="flex items-start justify-between gap-3 mb-5">
              ...
              <span className="px-3 py-1 bg-background border border-border text-xs font-medium rounded-full shrink-0">
                2024
              </span>
            </div>

            <h3 className="font-serif text-xl font-bold text-foreground leading-snug mb-4">
              Exploring AI-Driven Solutions in Cross-Cultural UX Adaptation (Cambodia & Japan)
            </h3>

            <p className="text-foreground/75 leading-relaxed mb-7 text-sm flex-1">
            ...
            <div className="flex flex-wrap items-center justify-between gap-4 pt-5 border-t border-border/60 mt-auto">
